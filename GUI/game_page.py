...
class GamePage(QFrame):
    ...
    def setup_layouts(self):
        ...
        center_spacer2 = QSpacerItem(20, 20, QSizePolicy.Expanding, QSizePolicy.Expanding)
    ...
    def setup_output_folder(self):
        ...
        self.select_output_folder_lb = QLabel('输出路径')
        ...
        self.select_output_folder_line_edit = FLineEdit(place_holder_text='指定输出路径', height=30, radius=12, text_padding=10)
    ...
    def setup_run_part(self):
        ...
        self.status_progress_bar.setValue(50)
