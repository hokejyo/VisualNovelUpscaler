...
class KirikiriPart(QFrame):
    ...
    def setup_work_up(self):
        ...
        layout = QVBoxLayout(self.work_up_frame)

        hlayout1 = QFormLayout()
        layout.addLayout(hlayout1)
        self.tlg_convert_lb = QLabel('TLG图片格式转换')
        # self.
        hlayout1.addWidget(self.tlg_convert_lb)
